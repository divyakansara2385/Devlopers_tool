...
with col1:
    query = st.text_input("", placeholder="Describe your idea...")

with col2:
    domain = st.selectbox("", ["Any","Web Dev","AIML","Data Scientist","Mobile Dev","App Dev"])

with col3:
    level = st.selectbox("", ["Any","Beginner","Intermediate","Advanced"])
